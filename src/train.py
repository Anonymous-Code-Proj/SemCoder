...
from src.dataset import get_data_collator, map_dataset, map_dataset_multitask
...
def train():
    ...
    # Decide which map_dataset function to use
    # ``map_dataset`` is a function that takes the raw examples as input
    # and processes them into a format that the model can process
    # if args.task == "nl2code":
    #     map_dataset = map_dataset_nl2code
    # elif args.task == "learn_exe":
    #     map_dataset = map_dataset_learn_exe
    # else:
    ...
    if args.task == "nl2code_exec" or args.task == "nl2code_exec_refine":
